...
/**
 * Creates a be_string from a given string
 * @param str The string to be converted
 * @param len The length of the string
 * @return The be_string or NULL if an error occurs
 */
be_string *str_create (const unsigned char *str, size_t len);
...
/**
 * Prints a value from a bencode dictionary to a bencoded file
 * @param key The key of the value to be printed
 * @param val The value to be printed
 * @param type The type of the value to be printed
 * @param file The file to which the value is to be printed
 */
